    ...
    return (
        <HashRouter>
            <header style={{ padding: '2vh 3vw', width: '94vw', height: '5vh' }}>
                <Link to='/'>
                    <button className='header-left' style={{ outline: 'none',border:'0', backgroundColor: 'transparent', color: 'white', fontWeight: 'bolder', textAlign: 'center', float: 'left', cursor: 'pointer', width: '60px', height: '60px', borderRadius: '100%' }}>
                        <div>What</div>
                        <div>Movie</div>
                        <div>Tonight</div>
                    </button>
